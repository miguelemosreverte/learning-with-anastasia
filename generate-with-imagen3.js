...
The Chrysomallon squamiferum (iron snail) has:
...
async function generateIronSnailImage(prompt, outputPath) {
  ...
  // Use the Imagen 3 model through Gemini
...
async function main() {
  ...
  if (!apiKey) {
    console.error("❌ Error: Please set GOOGLE_AI_API_KEY or GEMINI_API_KEY environment variable");
    console.log("\nTo get an API key:");
    console.log("1. Go to https://aistudio.google.com/apikey");
    console.log("2. Create a new API key");
    console.log("3. Set it: export GOOGLE_AI_API_KEY='your-key-here'");
    process.exit(1);
  }

  console.log("🎨 Starting Gemini Imagen 3 image generation...");
